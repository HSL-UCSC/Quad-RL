...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETENVIRONMENTREQUEST']._serialized_end=581
  _globals['_VERTEX']._serialized_start=583
  _globals['_VERTEX']._serialized_end=630
  _globals['_POINT']._serialized_start=632
